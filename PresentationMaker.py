...
def create_presentation_from_template(content, topic, template_file, progress_bar):
    ...
    subtitle = slide.placeholders[1] if len(slide.placeholders) > 1 else None  # Safely access placeholder
    title.text = topic
    if subtitle:
    ...
    # Safely access the title and content placeholders
    title = slide.shapes.title
    body = slide.shapes.placeholders[1] if len(slide.placeholders) > 1 else None  # Placeholder index 1
